...
const Home = () => {
    ...
    <div className="App">
      <div className="container">
        ...
        <span>
          SEGUNDA A DOMINGO DAS 17:00 AS 22:00
        </span>
      </div>
      <Navbar />
      ...
      <div className="opcoes-hamburguer-container">
        ...
        <div className="opcao-hamburguer3">
            <img src="./assets/opcao-mega-hamburgueres.jpeg" alt="Hamburguer Mega" />
    ...
    <div className="grupo-2">
        ...
        <div className="opcao-hamburguer6">
            <img src="./assets/opcao-xtudo-hamburgueres.png" alt="X-Tudo" />
                <h1>X-Tudo</h1>
            </div>
        </div>
    </div>
          <div className="container">
              ...
              <div class="opcao-acompanhamentos-container">
                ...
                <div className="opcao-acompanhamento2">
                  <img src="./assets/opcao-macaxeira-frita-acompanhamentos.png" alt="Macaxeira Frita" />
                  <p>Macaxeira Frita</p>
               </div>
